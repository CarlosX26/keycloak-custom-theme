...
export default function Login(
    ...
    return (
        <div className="h-screen overflow-hidden flex justify-center items-center bg-gradient-to-r from-blue-300 to-white">
            <div className="min-h-screen">
                <div className="animate-slideUp">
                    <div className="relative">
                        <div className="flex justify-center items-center absolute bottom-10 left-0 right-0">
                            <img src={Truck} className="w-96 h-96" />
                        </div>
                        <div className="flex justify-center">
                            <div className="w-1 h-40 bg-gray-900"></div>
                        </div>
                    </div>
